...
// UpdatePlayerLocation(); UpdateCachedUser(); }

// [System.Web.Http.HttpPost] public override HttpResponseMessage Rpc() { try {
// Log.Debug($"HasSignature:{CachedCurrentUser.HasSignature}"); if (CachedCurrentUser.HasSignature ==
// false) { if (ProtoResponse.Unknown6 != null) { //POGOProtos.Networking.Envelopes.Signature
// //connectedClient.HttpContext.Request.Unknown6.Unknown2.EncryptedSignature var signature =
// Encryption.Decrypt( ProtoRequest.Unknown6.Unknown2.EncryptedSignature.ToByteArray()); var
// codedStream = new CodedInputStream(signature); var sig = new Signature();
// sig.MergeFrom(codedStream); if (sig.DeviceInfo != null) { var usrd = CachedCurrentUser;
// usrd.HasSignature = true; usrd.IsIOS = (sig.DeviceInfo.DeviceBrand == "Apple"); bool updtrslt =
// WebApiApplication.AuthenticatedUsers.TryUpdate(UserEmail, usrd, CachedCurrentUser); if (!updtrslt)
